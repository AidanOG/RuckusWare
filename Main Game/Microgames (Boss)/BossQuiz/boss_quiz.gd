...
var question_list_easy = [
	...
	["What is Master Chief's given first name?", "John", "", "", "", "Abraham", "David", "Isaiah", "Zion", "Justin", "Zachary", "Elliot", "Joel", "Peter", "Jeremy", "Salem", "Kane", "Jacob", "Alan", "Aiden", "Kyle", "Wayne", "James", "Bruce", "Chief"],
	...
	["Who is the final boss in (vanilla) [i]Terraria[/i]?", "Moon Lord", "", "", "", "Cthulhu", "Supreme Calamitas", "Devourer of Gods", "Wall of Flesh", "Empress of Light", "Slime God", "Lunatic Cultist", "Exo Mechs", "Ocram", "Hive Mind of Cthulhu", "Ancient Vision", "Phantasm Dragon", "True Eye of Cthulhu", "Terrarian"],
	...
	["What iconic item is usually used to save your game progress in [i]Resident Evil[/i] games?", "Typewriter", "", "", "", "Tape Recorder", "Video Camera", "Diary", "Bed", "Toilet", "Mirror", "Cell Phone", "Bathroom Sink", "Ink and Quill"],
	...
	["What does the acronym \"MMORPG\" stand for?", "Massively Multiplayer Online Role-Playing Game", "", "", "", "Massively Multiplayer Online Rocket-Propelled Grenade", "Multi-Mode Online Role-Playing Game", "Massively Multiplayer Online Reality Play Game", "Multiplayer Medieval Online Role-Playing Game", "Massive Magic Online Role-Playing Game", "Multiplayer Massive Online Role-Playing Game", "Massively Multiplayer Online Reality Play Game"]
]
...
var question_list_medium = [
	...
	["The protagonist from [i]One Shot[/i] is named after which famous inventor?", "Nikola Tesla", "", "", "", "Albert Einstein", "J. Robert Oppenheimer", "Alexander Graham Bell", "Thomas Edison", "Madam C.J. Walker", "Orville Wright", "Wilbur Wright", "Ada Lovelace", "Hedy Lamarr", "Nicholas Cage"],
	...
	["The Lowain Bros from [i]Granblue Fantasy[/i] are also collectively known as _____.", "The Brofam", "", "", "", "Dandylions Blooming in the Tosh", "The Bromance", "The Kat Fan Club", "The Yggy Fan Club", "The Freezie Fan Club", "The Swinger Trio", "The Human Pyramid", "The Dudebros", "The Shadow Triad"],
	["In [i]Pokémon Diamond[/i], [i]Pokémon Pearl[/i], and [i]Pokémon Platinum[/i], the device obtained in Jubilife City that occupies the DS' touch screen is called the _____.", "Pokétch", "", "", "", "Pokétech", "Pokédex", "PokéNav", "Pokégear", "C-Gear", "Cell Phone", "Xtransceiver", "Vs. Recorder"],
	...
	["Who is the titular \"Twilight Princess\" from the [i]The Legend of Zelda: Twilight Princess[/i]?", "Midna", "Princess Zelda", "", "", "Princess Hilda", "Ilia", "Impa", "Epona", "Nayru", "Din", "Farore", "Mipha"]
]
